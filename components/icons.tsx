 ...
 * Used by both the admin and dashboard sidebars to avoid duplication.
 * All icons accept standard SVGProps so className / width / height can be
...
export function HelpCircleIcon(props: SVGProps) {
  return (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
