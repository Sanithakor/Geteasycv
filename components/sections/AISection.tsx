...
export default function AISection() {
  ...
  return (
    <section className="py-16 sm:py-24 bg-gradient-to-br from-purple-50/50 via-white to-slate-50 font-sans border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-50 text-purple-600 border border-purple-200/80 rounded-full font-bold text-xs uppercase tracking-wider">
              ...
              {aiFeatures.map((feat, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-start gap-4 p-3 rounded-md hover:bg-white transition-all">
                    <div className="w-10 h-10 rounded-md bg-purple-100/80 text-purple-600 flex items-center justify-center shrink-0">
            ...
            <div className="pt-4 space-y-4">
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  href="/editor"
                  className="px-6 py-3.5 bg-purple-600 hover:bg-purple-700 text-white font-bold text-sm rounded-md shadow-md hover:shadow-lg transition-all inline-flex items-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-5 py-3.5 bg-white border border-purple-200 text-purple-700 hover:bg-purple-50 font-bold text-sm rounded-md shadow-2xs transition-all inline-flex items-center gap-2 cursor-pointer"
                >
              ...
              <div className="bg-white border border-purple-100 rounded-md p-4 shadow-xs space-y-3">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-purple-50/90 border border-purple-200/80 rounded-md p-4 flex items-start gap-3 text-left">
