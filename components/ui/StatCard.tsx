...
export default function StatCard({ title, value, trend, trendUp = true, icon, iconBg = 'bg-violet-50 text-violet-600', sparklinePoints, sparklineColor = '#8b5cf6', className = '' }: StatCardProps) {
  return (
