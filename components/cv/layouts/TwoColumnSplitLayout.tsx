// Two Column Split Layout - Balanced two-column layout
...
export type TwoColumnSplitLayoutProps = {
  data: CVData;
  theme: Theme;
...
const TwoColumnSplitLayout: React.FC<TwoColumnSplitLayoutProps> = ({
  data,
  theme,
...
export default TwoColumnSplitLayout;